...
public class SQLSchema
{
	...
	public static final String NickNameTable_Insert_WhiteList ="INSERT INTO player_nickname_data VALUES(?,?,NULL,NULL);";
	public static final String NickNameTable_Delete_WhiteList ="DELETE FROM player_nickname_data WHERE playeruuid=?";
}
